                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="create-post mb-5">
                            <div class="static-section">
                                <form action="{{ url('/') }}/komentar_post" method="POST">
                                    @csrf
                                    <div class="search-input input-style icon-right">
                                        ...
                                        <input type="hidden" class="form-control enable" name="user_id"
                                            value="{{ Auth::user()->id }}">
                                        <input type="hidden" class="form-control enable" name="post_id"
                                            value="{{ $post->id }}">
                                    </div>
                            </div>
                            <div class="post-btn">
...
<body>
    ...
    <div class="pre-loader">
        ...
        <!-- page body start -->
        <div class="page-body container-fluid newsfeed-style5">
            ...
            <div class="page-center">
                ...
                <div class="story-section ratio_115">
                    <div class="slide-7 no-arrow default-space">
                        <div>
                            <div class="story-box">
    ...
    <div class="page-body container-fluid newsfeed-style5">
        ...
        <div class="sidebar-panel panel-lg sidebar-light">
            <div class="user-wrap">
                <div class="profile-img">
                    <div>
                        <img src="../assets/images/story/8.jpg" class="img-fluid blur-up lazyload bg-img" alt="profile">
                    </div>
                    <span class="stats">
                        <img src="../assets/images/icon/verified.png" class="img-fluid blur-up lazyload" alt="verified">
                    </span>
                </div>
                <div class="user-info">
                    <h3>Paige Turner</h3>
            ...
            <ul class="sidebar-icon">
                <li class="active">
                    <a href="#">
                        <img src="../assets/svg/sidebar-vector/news.svg" class="bar-icon-img" alt="news">
                        <h4>newsfeed</h4>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src="../assets/svg/sidebar-vector/star.svg" class="bar-icon-img" alt="favourite">
                        <h4>favourite</h4>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src="../assets/svg/sidebar-vector/friends.svg" class="bar-icon-img" alt="group">
                        <h4>group</h4>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src="../assets/svg/sidebar-vector/headphones.svg" class="bar-icon-img" alt="music">
                        <h4>music & video</h4>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src="../assets/svg/sidebar-vector/sky.svg" class="bar-icon-img" alt="weather">
                        <h4>weather</h4>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src="../assets/svg/sidebar-vector/calendar.svg" class="bar-icon-img" alt="calendar">
                        <h4>calender</h4>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src="../assets/svg/sidebar-vector/cake-pop.svg" class="bar-icon-img" alt="event">
                        <h4>events</h4>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <img src="../assets/svg/sidebar-vector/games.svg" class="bar-icon-img" alt="games">
                        <h4>games</h4>
                    </a>
                </li>
            </ul>
            <div class="main-icon">
                <a href="#">
                    <img src="../assets/svg/sidebar-vector/next.svg" class="bar-icon-img" alt="logout">
                    <h4>logout</h4>
                </a>
            </div>
        </div>
                    ...
                    <div class="content-center">
                        ...
                        <div class="post-panel infinite-loader-sec section-t-space">
                                ...
                                <div class="post-details">
                                    <div class="img-wrapper">
                                        <div style="width:100%;height:0;padding-bottom:56%;position:relative;"><iframe
                                                src="https://giphy.com/embed/xl2zRzM8sVo3td58kS"
                                                style="position:absolute" class="giphy-embed w-100 h-100"
                            ...
                            <div class="post-wrapper col-grid-box section-t-space">
                                <div class="post-title">
                                    <div class="profile">
                                        <div class="media">
                                            <a class="popover-cls user-img" data-bs-toggle="popover" data-placement="right"
                                                data-name="gemix store" data-img="../assets/images/logo/1.jpg">
                                ...
                                <div class="post-details">
                                                        ...
                                                        <a href="#" class="img-part">
                                                            <div class="image">
                                                                <img src="../assets/images/products/2.jpg"
                                                                    class="img-fluid blur-up lazyload bg-img" alt="img">
                                                            </div>
                                                        </a>
                                                        <div class="slider-content">
                                                            <h5><span>Natural juice</span> Fresh and natural, Orange
                                                                Juice. -50%</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="detail-box">
                                        <h3>🎉 Welcome to gemix online shopping store</h3>
                                        <h5 class="tag"><span>#Onlineshopping,</span> #shopping, #sale, #bigdiscount
                                        </h5>
                                        <p>$1 To win $99 deals for new users save more in group buy&flash sale, Limited
                                            time sale . <span>Hurry Up!!!!!</span></p>
                                        <div class="bookmark favourite-btn">
                                            <i class="iw-14 ih-14" data-feather="bookmark"></i>
                                        </div>
                                        <div class="people-likes">
                            ...
                            <div class="post-wrapper col-grid-box section-t-space">
                                ...
                                <div class="post-details">
                                    ...
                                    <div class="detail-box">
                                        ...
                                        <h5 class="tag"><span>#Musiccelebration,</span> #music, #party, #music
                                        </h5>
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                            has been the industry's standard dummy text ever since the 1500s
                                        </p>
                            ...
                            <div class="post-wrapper col-grid-box section-t-space">
                                ...
                                <div class="post-details">
                                    <div class="img-wrapper">
                                        <img src="../assets/images/post/3.jpg" class="img-fluid blur-up lazyload"
                                            alt="">
                                        <div class="controler">
                                            <a href="#" class="play">
                                                            ...
                                                            <div class="col-12 pt-cls p-0">
                                                                <div class="overlay">
                                                                    <div class="portfolio-image">
                                                                        <a href="javascript:void(0)" data-bs-toggle="modal"
                                                                            data-bs-target="#imageModel">
                                                                            <img src="../assets/images/post/5.jpg"
                                                                                alt=""
                                                                                class="img-fluid blur-up lazyload bg-img">
                                                                        </a>
                                                                    </div>
        ...
        <div class="conversation-panel">
            ...
            <div class="friend-section">
                <div class="header-section">
                    <a data-bs-toggle="collapse" href="#accordion1" aria-expanded="true" class="">recent chats
                        <div class="down-arrow">
                            <i data-feather="chevron-down" class="icon-theme iw-14 ih-14"></i>
                        </div>
                    </a>
                ...
                <div id="accordion1" class="friend-list collapse show">
                    <ul>
                        <li class="friend-box user3">
                            <div class="media">
                                <a class="popover-cls user-img" data-bs-toggle="popover" data-placement="right"
                                    data-name="josephin water" data-img="../assets/images/user-sm/3.jpg">
                        ...
                        <li class="friend-box user5">
                            <div class="media">
                                <a class="popover-cls user-img" data-bs-toggle="popover" data-placement="right"
                                    data-name="anna sthesia" data-img="../assets/images/user-sm/5.jpg">
    ...
    <!-- gallery image model -->
    <div class="modal comment-model" id="imageModel" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div>
                                                        ...
                                                        <li class="react-btn">
                                                            ...
                                                            <div class="react-box">
                                                                <ul>
                                                                    <li data-title="smile">
                                                                        <a href="javascript:void(0)">
                                                                            <img src="../assets/svg/emoji/040.svg"
                                                                                alt="smile">
                                                                        </a>
                                                                    </li>
                                                                    <li data-title="love">
                                                                        <a href="javascript:void(0)">
                                                                            <img src="../assets/svg/emoji/113.svg"
                                                                                alt="heart">
                                                                        </a>
                                                                    </li>
                                                                    <li data-title="cry">
                                                                        <a href="javascript:void(0)">
                                                                            <img src="../assets/svg/emoji/027.svg"
                                                                                alt="cry">
                                                                        </a>
                                                                    </li>
                                                                    <li data-title="wow">
                                                                        <a href="javascript:void(0)">
                                                                            <img src="../assets/svg/emoji/052.svg"
                                                                                alt="angry">
                                                                        </a>
                                                                    </li>
                                                                    <li data-title="angry">
                                                                        <a href="javascript:void(0)">
                                                                            <img src="../assets/svg/emoji/039.svg"
                                                                                alt="angry">
                                                                        </a>
                                                                    </li>
                                                                    <li data-title="haha">
                                                                        <a href="javascript:void(0)">
                                                                            <img src="../assets/svg/emoji/042.svg"
                                                                                alt="">
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                    ...
                                    <div class=" btn-group custom-dropdown arrow-none dropdown-sm">
                                        <h6 data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="icon-font-light left-icon iw-12 ih-12"
                                                ...
                                                data-feather="chevron-down"></i></h6>
                                        <div class="dropdown-menu custom-dropdown">
                                            <ul>
                                                <li>
                                                    <a href=""><i class="icon-font-light iw-16 ih-16"
